%% run evacuation simulation in baker building 10 times (with fire), and compute the average, with door between library and language unit, this script sets health points to 300


classdef FireSimulation7 < handle
    methods
        function run(self)
