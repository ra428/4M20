%% run evacuation simulation in baker building 10 times (with fire), and compute the average, without door between library and language unit, this script sets health points to 300


classdef FireSimulation8 < handle
    methods
        function run(self)
...
%                 door{13} = Door(13, false, 24/sf, 8/sf);        % Door between stairs and library
                ...
                room{15} = Room(15, [44 12]/sf, [64 12]/sf, [44 0]/sf, [64 0]/sf, [door{27}], firePosition1);                               % LR 6, BE1-16
                ...
                room{17} = Room(17, [64 15]/sf, [75 15]/sf, [64 6]/sf, [75 6]/sf, [door{26}, door{27}, door{28}, ...
                    door{29}, door{30}, door{31}, door{32}], firePosition2);                                                                % Lobby, BS1-18
                ...
                % set health points to 300
                for i = 1: numel(vehicles)
                   vehicles(i).healthPoints = 30;
                end
