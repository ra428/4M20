%% run evacuation simulation in baker building 10 times (no fire), and compute the average, with door between library and language unit


classdef FireSimulation5 < handle
    methods
        function run(self)
